import {
  ...
  Form_default,
  require_warning
} from "./chunk-ZNHLLZTK.js";
import {
  Row_default
} from "./chunk-CYZQGDGA.js";
import {
  InputGroupContext_default,
  InputGroup_default
} from "./chunk-4XVDH7BX.js";
import "./chunk-3HPQKGQZ.js";
import {
  addClass,
  hasClass,
  removeClass
...
import {
  ...
  useUncontrolledProp,
  useWillUnmount
} from "./chunk-74W7VOJN.js";
import {
  forEach,
  map
} from "./chunk-MRTD3HAV.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
  EXITING
} from "./chunk-SCNPJSWY.js";
import {
  require_prop_types
} from "./chunk-KO5HLORH.js";
import {
  require_react_dom
} from "./chunk-IXFEQHCS.js";
import {
  Button_default
} from "./chunk-TK53SHQQ.js";
import "./chunk-A2CU5O6L.js";
import {
  Col_default,
  useCol
} from "./chunk-CL4WVTWG.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-RLZQQ335.js";
import {
  require_jsx_runtime
} from "./chunk-DE2SCALD.js";
import {
  require_react
...
var CardBody = React21.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var context3 = React23.createContext(null);
...
var CardImgOverlay = React26.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React27.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React28.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React29.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var CardGroup = React32.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react14.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context5 = (0, import_react19.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
function useNavItem({
  ...
  const navContext = (0, import_react24.useContext)(NavContext_default);
...
var Nav = React57.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react25.useRef)(false);
  const parentOnSelect = (0, import_react25.useContext)(SelectableContext_default);
  const tabContext = (0, import_react25.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react25.useRef)(null);
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react26.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react27.useRef)(inProp);
  ...
  const child = (0, import_react27.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react28.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
function useTransition({
  ...
  const isInitialRef = (0, import_react29.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react29.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react29.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var Modal = (0, import_react30.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  return (0, import_jsx_runtime57.jsx)(import_jsx_runtime58.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime59.jsxs)(import_jsx_runtime58.Fragment, {
...
var AbstractModalHeader = React67.forwardRef(({
  ...
  const context5 = (0, import_react31.useContext)(ModalContext_default);
...
var ModalHeader = React68.forwardRef(({
  ...
  return (0, import_jsx_runtime65.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var Modal2 = React70.forwardRef(({
  ...
  const renderBackdrop = (0, import_react32.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
...
var NavbarCollapse = React75.forwardRef(({
  ...
  const context5 = (0, import_react34.useContext)(NavbarContext_default);
...
var OffcanvasToggling = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime75.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React78.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames56.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var Offcanvas = React81.forwardRef(({
  ...
  const renderBackdrop = (0, import_react38.useCallback)((backdropProps) => (0, import_jsx_runtime78.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React82.forwardRef((props, ref) => {
  const context5 = (0, import_react39.useContext)(NavbarContext_default);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime95.jsxs)(import_jsx_runtime94.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react45.cloneElement)(children, triggerProps), (0, import_jsx_runtime93.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Spinner = React100.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react47.useContext)(TabContext_default);
  if (!context5)
    return [Object.assign({}, props, {
      role
    }), {
...
var TabContent = React106.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastHeader = React112.forwardRef(({
  ...
  const context5 = (0, import_react49.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React114.forwardRef(({
  ...
  const delayRef = (0, import_react50.useRef)(delay);
  const onCloseRef = (0, import_react50.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react50.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react50.useMemo)(() => ({
    onClose
  }), [onClose]);
