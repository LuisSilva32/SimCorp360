...
var He = function(t2) {
  ...
  for (var s3 in t2) {
    var i3 = t2[s3];
    t2.hasOwnProperty(s3) && !qe(i3) && (Array.isArray(i3) && i3.isCss || re(i3) ? r3.push("".concat(We(s3), ":"), i3, ";") : ce(i3) ? r3.push.apply(r3, __spreadArray(__spreadArray(["".concat(s3, " {")], He(i3), false), ["}"], false)) : r3.push("".concat(We(s3), ": ").concat((n = s3, null == (o2 = i3) || "boolean" == typeof o2 || "" === o2 ? "" : "number" != typeof o2 || 0 === o2 || n in emotion_unitless_esm_default || n.startsWith("--") ? String(o2).trim() : "".concat(o2, "px")), ";")));
  }
  return r3;
};
